...
const MenuList2 = `Hello @${i.id.split("@")[0]} (≧▽≦), Terimakasih Sudah Memakai Bot Ini Mohon Maaf Jika Masih Ada Beberapa Fitur Yang Error🙏 Silahkan Klick Button Dibawah Untuk Mengakses Bot Ini`
...
if (q.includes('--help')) return reply(examquery) 
  ...
  case 'arielsp':{
 {
 	           const arielkece = `*Hii Kak* @${i.id.split("@")[0]} (≧▽≦)
